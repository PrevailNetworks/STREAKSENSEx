    ...
    <header className="mb-6 pb-6 border-b border-[var(--border-color)]">
      <div className="container mx-auto flex flex-col sm:flex-row justify-between items-center">
        <div className="logo text-center sm:text-left mb-4 sm:mb-0">
          <h1 className="font-['Orbitron'] text-3xl sm:text-4xl text-[var(--primary-glow)] tracking-wider" style={{ textShadow: '0 0 8px var(--primary-glow)' }}>
            STREAKSENSE
          </h1>
          <span className="font-['Roboto'] text-xs sm:text-sm text-[var(--text-secondary)] tracking-[4px] uppercase">
            ANALYTICS HUB
          </span>
        </div>
        <div className="date-picker-container">
          ...
          <input
            ...
            className="bg-[var(--bg-card)] border border-[var(--border-color)] text-[var(--text-primary)] p-2.5 rounded-md font-['Roboto'] w-full sm:w-auto text-center appearance-none focus:outline-none focus:ring-2 focus:ring-[var(--primary-glow)]"
