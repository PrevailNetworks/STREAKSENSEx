  ...
  return (
    <section className="bg-[var(--bg-card)] p-6 rounded-lg shadow-xl border border-[var(--border-color)] backdrop-blur-sm">
      <div className="flex justify-between items-center mb-4">
        <h2 className="text-2xl font-['Orbitron'] text-[var(--primary-glow)]">Executive Summary</h2>
        <span className="text-sm text-[var(--text-secondary)] font-['Orbitron']">{reportDate}</span>
      </div>
