...
export interface RecommendationItemProps {
  ...
  index?: number;
  // itemKey?: string; // Removed: Replaced by standard React key prop
...
export const RecommendationItem: React.FC<RecommendationItemProps> = ({ 
  player, onSelect, isSelected, isSelectable, index, /* itemKey commented out, was already so */
  ...
  return (
  <li
    // Removed key from here: key={itemKey || `rec-${player.player}-${index}`}
    // The 'key' prop is applied by the parent component when mapping over RecommendationItem instances.
